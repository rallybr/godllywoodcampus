-- 🔧 CORREÇÃO SIMPLES PARA NÍVEL JOVEM
...
-- ============================================
-- 2. RECRIAR APENAS COM A CORREÇÃO PARA JOVEM
-- ============================================

-- SELECT - CORREÇÃO: permite usuario_id NULL para nível jovem
CREATE POLICY "jovens_select_by_hierarchy" ON public.jovens
FOR SELECT TO authenticated
USING (
  -- Todos os outros níveis (mantém como estava)
  ...
  OR
  -- JOVEM: CORREÇÃO - permite usuario_id NULL
...
-- INSERT - CORREÇÃO: permite usuario_id NULL para nível jovem
...
-- UPDATE - CORREÇÃO: permite usuario_id NULL para nível jovem
