-- =====================================================
-- Script para migrar dados completos dos estados duplicados
-- =====================================================
...
-- PASSO 2: Limpar TODAS as referências geográficas dos jovens que serão migrados
...
-- PASSO 9: Mostrar jovens migrados (sem referências geográficas)
SELECT 
  'JOVENS MIGRADOS (SEM REFERÊNCIAS GEOGRÁFICAS)' as tipo,
  j.id as jovem_id,
  j.nome_completo,
  j.estado_id,
...
WHERE j.estado_id = '182c2fcc-122a-4742-99e2-3622a276070c'
  AND j.bloco_id IS NULL 
  AND j.regiao_id IS NULL 
  AND j.igreja_id IS NULL
ORDER BY j.nome_completo;
