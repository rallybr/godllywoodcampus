-- CORRIGIR FUNÇÃO COM HIERARQUIA GEOGRÁFICA CORRETA
-- Baseado na estrutura das tabelas e hierarquia geográfica
...
SELECT 'Função corrigida com hierarquia geográfica' as teste, COUNT(*) as total FROM public.get_jovens_por_estado_count(NULL);
