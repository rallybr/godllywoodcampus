-- CORREÇÃO FINAL PARA COLABORADOR
-- Colaborador deve ver APENAS os jovens que ele cadastrou
...
BEGIN
  ...
  -- 7. COLABORADOR - Acesso APENAS aos dados de viagem dos jovens que cadastrou
  IF user_info.nivel = 'colaborador' THEN
    RETURN EXISTS (
      SELECT 1 FROM public.jovens j
      WHERE j.estado_id = jovem_estado_id
