-- =====================================================
-- Script para reabilitar RLS policies de forma segura (CORRIGIDO)
-- =====================================================
...
-- 3. Remover todas as policies existentes para evitar conflitos
DO $$
DECLARE
  r record;
BEGIN
  FOR r IN (SELECT policyname, tablename FROM pg_policies WHERE schemaname = 'public') LOOP
    ...
    RAISE NOTICE 'Política RLS ''%'' na tabela ''%'' removida.', r.policyname, r.tablename;
  END LOOP;
END
$$;

-- 4. Criar policies básicas e seguras para cada tabela
...
-- 5. Verificar o status final das policies
SELECT 
  schemaname,
  tablename,
  policyname,
...
-- RLS policies reabilitadas com sucesso!
-- As policies foram criadas baseadas na hierarquia de níveis de acesso.
-- Teste o sistema para verificar se está funcionando corretamente.
