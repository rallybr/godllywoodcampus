-- CORRIGIR FUNÇÃO EXISTENTE PARA IMPLEMENTAR HIERARQUIA
-- Usando a mesma lógica que já funciona em can_access_jovem
...
BEGIN
  ...
  -- 4. LÍDERES DE BLOCO - Visão de bloco (estados do bloco)
  ...
  -- 5. LÍDER REGIONAL - Visão regional (estados da região)
  ...
  -- 6. LÍDER DE IGREJA - Visão de igreja (estado da igreja)
...
SELECT 'Teste - Função Corrigida' as teste, COUNT(*) as total FROM public.get_jovens_por_estado_count(NULL);
