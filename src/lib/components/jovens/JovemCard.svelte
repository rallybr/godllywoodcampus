...
<div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group overflow-hidden border border-gray-100">
  ...
  <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 sm:p-6 border-b border-gray-100">
    <div class="flex items-start space-x-3 sm:space-x-6">
      ...
      <div class="relative flex-shrink-0">
        <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl overflow-hidden border-4 border-white shadow-lg">
          {#if jovem.foto}
            <img
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="mb-3 sm:mb-4">
          <div class="mb-2">
            <h3 class="text-lg sm:text-2xl font-bold text-gray-900 truncate">
              {jovem.nome_completo}
            </h3>
          </div>
          <div class="flex items-center justify-between text-sm text-gray-600">
            ...
            <!-- Status badge -->
            <span class="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs font-semibold border-2 border-white shadow-md {getAprovadoColor(jovem.aprovado, jovem.tem_avaliacoes)} flex-shrink-0">
          ...
          <div class="mt-2">
            <span class="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-blue-100 text-blue-800">
              <svg class="w-3 h-3 sm:w-4 sm:h-4 mr-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
              <span class="truncate">{jovem.edicao?.nome || jovem.edicao || 'N/A'}</span>
            </span>
          </div>
        </div>
      </div>
  ...
  <div class="p-4 sm:p-6">
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
      <!-- Bloco -->
      <div class="flex items-center space-x-2 sm:space-x-3 p-3 sm:p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
  ...
  <!-- Actions -->
  <div class="px-4 sm:px-6 py-4 sm:py-5 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200">
    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
      <button 
        on:click={handleView}
        class="flex-1 flex items-center justify-center py-2 sm:py-3 px-3 sm:px-4 rounded-xl border-2 border-gray-300 text-gray-700 font-semibold hover:bg-blue-50 hover:border-blue-400 hover:text-blue-700 transition-all duration-200 group-hover:shadow-md text-sm sm:text-base"
      >
        <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <button 
        ...
        class="flex-1 flex items-center justify-center py-2 sm:py-3 px-3 sm:px-4 rounded-xl border-2 border-purple-300 text-purple-700 font-semibold hover:bg-purple-50 hover:border-purple-400 hover:text-purple-800 transition-all duration-200 group-hover:shadow-md text-sm sm:text-base"
      >
        <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
        <span class="truncate">Ver Ficha</span>
      </button>
      
      <button 
        on:click={handleEvaluate}
        class="flex-1 flex items-center justify-center py-2 sm:py-3 px-3 sm:px-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 text-sm sm:text-base"
      >
        <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
        </svg>
        <span class="truncate">Avaliar</span>
      </button>
    </div>
  </div>
</div>
