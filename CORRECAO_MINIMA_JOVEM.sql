-- 🔧 CORREÇÃO MÍNIMA PARA NÍVEL JOVEM
-- Apenas corrige a linha específica que está bloqueando o jovem
...
USING (
  -- Mantém todas as condições existentes
