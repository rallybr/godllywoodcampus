-- =====================================================
-- CORREÇÃO: Função aprovar_jovem_multiplo com suporte a associações
-- =====================================================
-- Problema: A função atual não considera associações da tabela jovens_usuarios_associacoes
-- Solução: Atualizar para usar can_access_jovem_com_associacoes

-- 1. Primeiro, criar a função can_access_jovem_com_associacoes (se não existir)
...
-- 2. Atualizar a função aprovar_jovem_multiplo para usar a nova verificação
