-- =====================================================
-- CORREÇÃO COMPLETA DO SISTEMA DE NÍVEIS
-- =====================================================
-- Problema: Usuário jovem aparece como "Desconhecido" e vê dados de administrador
-- Causa: Função has_role incorreta e policies RLS permitindo acesso total
-- Solução: Corrigir função has_role e implementar policies baseadas em níveis
...
-- ============================================
-- 3. CRIAR POLICIES CORRETAS PARA JOVENS
-- ============================================
...
-- ============================================
-- 4. CRIAR POLICIES CORRETAS PARA DADOS_VIAGEM
-- ============================================
...
-- ============================================
-- 5. CRIAR POLICIES CORRETAS PARA AVALIACOES
-- ============================================
...
-- Testar a função has_role corrigida
SELECT 
  'Teste da função has_role:' as status,
...
SELECT 'Correção completa aplicada com sucesso!' as status;
